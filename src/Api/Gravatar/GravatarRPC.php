...
class GravatarRPC
{
    ...
    protected function call($method, $params = [])
    {
        ...
        $msg = new XML_RPC_Message("grav.$method", [XML_RPC_encode($params)]);
    ...
    public function exists($emails = [])
    {
        ...
        return $this->call('exists', ['hashes' => $emails]);
    }
     ...
     * @param bool Treat $data as string path to filename, slurp this
    ...
    public function saveData($data, $rating, $slurp = false)
    {
        ...
        if ($rating < 0 || $rating > 3) {
            throw new InvalidArgumentException('Rating should be a number from 0 to 3');
        }
        if ($slurp == true) {
    ...
    {
        $value = $this->call('deleteUserimage', [
            'userimage' => $image,
        ]);
